...
import com.cs.demo.Customer;
import com.cs.demo.Engine;
import com.cs.demo.FzBike;
...
public class Test {
	...
	/*	((ConfigurableListableBeanFactory) factory).addPropertyEditorRegistrar(new PropertyEditorRegistrar() {
		...
		/*FzBike fz= factory.getBean("fz", FzBike.class);
		FzBike fz1= factory.getBean("fz1", FzBike.class);*/
		Engine engine = factory.getBean("engine", Engine.class);
	}
}
